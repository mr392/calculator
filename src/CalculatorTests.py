...
class MyTestCase(unittest.TestCase):
    ...
    def test_add_method_calculator(self):
           addition_test_data = MyTestCase.csv_values("/src/Unit Test Addition.csv")
    ...
    def test_subtract_method_calculator(self):
        subtraction_test_data = MyTestCase.csv_values("/src/Unit Test Subtraction.csv")
    ...
    def test_multiply_method_calculator(self):
        multiplication_test_data = MyTestCase.csv_values("/src/Unit Test Multiplication.csv")
    ...
    def test_divide_method_calculator(self):
        division_test_data = MyTestCase.csv_values("/src/Unit Test Division.csv")
    ...
    def test_square_method_calculator(self):
        squared_test_data = MyTestCase.csv_values("/src/Unit Test Square.csv")
    ...
    def test_square_root_method_calculator(self):
        square_root_test_data = MyTestCase.csv_values("/src/Unit Test Square Root.csv")
